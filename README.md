...
- [x] Improve the homepage by adding watching recommendations, such as "Just Released" and "Popular Right Now" rows loaded from TMDB, shown before the user searches.
...
- [x] Persist the last selected Viduki API so it is remembered on reload.
